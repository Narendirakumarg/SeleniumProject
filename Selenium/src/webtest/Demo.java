...
public class Demo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement search1=driver.findElement(By.id("global-nav-typeahead"));
		Select select = new Select(search1);
		select.selectByValue("narendirakumar g");
		
//		new Select (driver.findElement(By.xpath("//*[@id=\"global-nav-typeahead\"]/div[1]/svg/use"))).selectByVisibleText("narendirakumar g");
//		search.submit();
//		
//		Select dropdown = new Select(driver.findElement(By.id("global-nav-typeahead")));
//		WebElement search = null;
//		search.sendKeys("narendirakumar g");
//		dropdown.selectByVisibleText("narendirakumar g");
